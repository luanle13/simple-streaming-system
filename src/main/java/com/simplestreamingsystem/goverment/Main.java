...
public class Main {
    public static void main(String[] args) {
        ...
        streetLaneStream.applyOperator(new PenaltyCalculator("penalty-calculator", 2, new FieldsGrouping()))
                        .applyOperator(new BankRequest("bank-request", 2, new FieldsGrouping()))
                        .applyOperator(new MessageShower("message-shower", 2, new FieldsGrouping()));
